...
<body>
	<div class="header">
		<div class="header_top">
			<div class="wrap">
			 <div class="logo">
						<a href="index.php"><h1 style="color:black;"><U>ELEGANCE SALON</U></h1> </a>
					</div>
			    <div class="call">
...
?>
                  ...
                  <div class="rsidebar span_1_of_3" style="margin-left:700px; margin-top:-250px; ">
					...
					<div class="post-grid">
						<img src="images/S8.jpeg" title="post1" alt="">
						<p>How to adapt your make-up if you wear glasses - tips and tricks to enhance your best features</p>
							<div class="clear"> </div>
					  </div>
					    <div class="post-grid">
							<img src="images/31.jpg" title="post1" alt="">
							  <p>Boots discount code deals: Get cheap Pampers nappies, a third off Olay Eye cream and half price vitamins</p>
                              <div class="clear"> </div>
						</div>
						<div class="post-grid">
							<img src="images/spa1.jpeg  " title="post1" alt="">
							  <p>Spa services for men are the fastest-growing segment in the industry; I have never heard of ‘man-scaping’ well.</p>
								<div class="clear"> </div>
						</div>
								<div class="clear"> </div>
						</div>
